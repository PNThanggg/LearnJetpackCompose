...
import com.pnt.clonejetsnack.data.model.SnackbarManager
...
class CartViewModel(
    ...
    /**
     * Factory for com.pnt.clonejetsnack.home.cart.CartViewModel that takes SnackbarManager as a dependency
     */
    companion object {
        fun provideFactory(
