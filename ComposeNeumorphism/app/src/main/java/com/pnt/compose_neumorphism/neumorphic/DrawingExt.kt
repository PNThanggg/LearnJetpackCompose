...
private fun ContentDrawScope.drawBlurredBackground(
    ...
    drawIntoCanvas { canvas ->
        ...
        val backgroundOffset = when (lightSource) {
            LightSource.TOP -> Offset(0f, displacement)
            LightSource.BOTTOM -> Offset(0f, -displacement)
...
private fun ContentDrawScope.drawForeground(
    ...
    drawIntoCanvas { canvas ->
        ...
        val backgroundOffset = when (lightSource) {
            LightSource.TOP -> Offset(0f, strokeWidth)
            LightSource.BOTTOM -> Offset(0f, -strokeWidth)
