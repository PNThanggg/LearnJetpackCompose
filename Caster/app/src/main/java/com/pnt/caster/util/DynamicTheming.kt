...
class DominantColorState(
    ...
    private suspend fun calculateDominantColor(url: String): DominantColors? {
        ...
        return calculateSwatchesInImage(context, url)
            ...
            // If we found a valid swatch, wrap it in a [com.pnt.caster.util.DominantColors]
            ?.let { swatch ->
                DominantColors(
            ...
            // Cache the resulting [com.pnt.caster.util.DominantColors]
