...
class PlayerViewModel(
    ...
    // episodeUri should always be present in the com.pnt.caster.presentation.player.PlayerViewModel.
    ...
    /**
     * Factory for com.pnt.caster.presentation.player.PlayerViewModel that takes EpisodeStore and PodcastStore as a dependency
     */
    companion object {
        fun provideFactory(
