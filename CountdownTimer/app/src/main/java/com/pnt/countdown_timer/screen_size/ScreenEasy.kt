...
//        Log.d("<>", "rotation: ${screenInfo.screenRotation()}");
    ...
    /**
     * return full com.pnt.countdown_timer.screen_size.width of the screen in pixel.
     * */
    val fullWidth get() = fullSize.width

    /**
     * return full com.pnt.countdown_timer.screen_size.height of the screen in pixel.
     * */
     ...
     *
     * @return A `com.pnt.countdown_timer.screen_size.ScreenPadding` object, which is a tuple of four integers representing
    ...
    /**
     * The safe com.pnt.countdown_timer.screen_size.width is the com.pnt.countdown_timer.screen_size.width of the screen after subtracting the system bar on the left and right sides
     *
     * Returns: Integer (pixel unit), the safe com.pnt.countdown_timer.screen_size.width of the screen.
     */
    val safeWidth: Int
        get() {
    ...
    /**
     * The safe com.pnt.countdown_timer.screen_size.height is the com.pnt.countdown_timer.screen_size.height of the screen after subtracting the system bar on the top and bottom sides
     *
     * Returns: Integer (pixel unit), the safe com.pnt.countdown_timer.screen_size.height of the screen.
     */
    val safeHeight: Int
        get() {
    ...
    /**
     * The safe size is the Size(com.pnt.countdown_timer.screen_size.width, com.pnt.countdown_timer.screen_size.height) of the screen after subtracting the system bar on all sides
     *
     * Returns: Integer (pixel unit), the safe com.pnt.countdown_timer.screen_size.height of the screen.
     */
    ...
    /**
     * @return status bar com.pnt.countdown_timer.screen_size.height (pixel unit)
     * */
    val statusBarHeight: Int get() = statusBarPadding.top

    /**
     * @return navigation bar com.pnt.countdown_timer.screen_size.height (both gesture and buttons in pixel unit)
     * */
     ...
     *
     * Returns: com.pnt.countdown_timer.screen_size.ScreenRotation
     */
