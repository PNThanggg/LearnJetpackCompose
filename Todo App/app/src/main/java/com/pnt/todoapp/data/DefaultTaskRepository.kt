...
import com.pnt.todoapp.di.ApplicationScope
import com.pnt.todoapp.di.DefaultDispatcher
...
class DefaultTaskRepository @Inject constructor(
    ...
    override suspend fun updateTask(taskId: String, title: String, description: String) {
        val task = getTask(taskId)?.copy(
            title = title,
            description = description
        ) ?: throw Exception("com.pnt.todoapp.data.Task (id $taskId) not found")
    ...
    /**
     * Get a com.pnt.todoapp.data.Task with the given ID. Will return null if the task cannot be found.
     *
     ...
     * data source.
     *
     * `withContext` is used here in case the bulk `com.pnt.todoapp.data.toLocal` mapping operation is complex.
     */
