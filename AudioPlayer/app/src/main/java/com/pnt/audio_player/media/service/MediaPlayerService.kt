package com.pnt.audio_player.media.service
...
import com.pnt.audio_player.R
import com.pnt.audio_player.media.constants.MediaConstant
import com.pnt.audio_player.media.exoplayer.MediaPlayerNotificationManager
import com.pnt.audio_player.media.exoplayer.MediaSource
...
class MediaPlayerService : MediaBrowserServiceCompat() {
    ...
    override fun onGetRoot(
        ...
        return BrowserRoot(MediaConstant.MEDIA_ROOT_ID, null)
    }
    ...
    override fun onCustomAction(
        ...
        when (action) {
            MediaConstant.START_MEDIA_PLAY_ACTION -> {
                mediaPlayerNotificationManager.showNotification(exoPlayer)
            }

            MediaConstant.REFRESH_MEDIA_PLAY_ACTION -> {
                mediaSource.refresh()
                notifyChildrenChanged(MediaConstant.MEDIA_ROOT_ID)
            }
