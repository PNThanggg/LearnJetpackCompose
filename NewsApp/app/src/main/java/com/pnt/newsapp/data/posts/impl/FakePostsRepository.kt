 ...
 * com.pnt.newsapp.data.posts.impl.getPosts with resources after some delay in a background thread.
 */
class FakePostsRepository : PostsRepository {
    ...
    override suspend fun getPost(postId: String?): BaseResult<Post> {
        return withContext(Dispatchers.IO) {
            ...
            if (post == null) {
                BaseResult.Error(IllegalArgumentException("Post not found"))
            } else {
