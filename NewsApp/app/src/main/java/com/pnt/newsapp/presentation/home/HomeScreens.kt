package com.pnt.newsapp.presentation.home

import PostCardHistory
import PostCardSimple
...
import com.pnt.newsapp.data.posts.impl.BlockingFakePostsRepository
import com.pnt.newsapp.presentation.components.NewsSnackbarHost
import com.pnt.newsapp.presentation.modifiers.interceptKey
import com.pnt.newsapp.presentation.rememberContentPaddingForScreen
import com.pnt.newsapp.presentation.theme.NewsTheme
import com.pnt.newsapp.presentation.utils.BookmarkButton
import com.pnt.newsapp.presentation.utils.FavoriteButton
import com.pnt.newsapp.presentation.utils.ShareButton
import com.pnt.newsapp.presentation.utils.TextSettingsButton
...
private fun HomeScreenWithList(
    ...
    Scaffold(
        snackbarHost = { NewsSnackbarHost(hostState = snackbarHostState) },
        topBar = {
            if (showTopAppBar) {
                HomeTopAppBar(
                    openDrawer = openDrawer,
...
fun PreviewHomeListDrawerScreen() {
    val postsFeed = runBlocking {
        (BlockingFakePostsRepository().getPostsFeed() as BaseResult.Success).data
    }
    NewsTheme {
        HomeFeedScreen(
            uiState = HomeUiState.HasPosts(
...
@Preview("Home list navrail screen", device = "id:pixel_7")
@Preview(
    "Home list navrail screen (dark)",
    uiMode = UI_MODE_NIGHT_YES,
    device = "id:pixel_7"
)
@Preview("Home list navrail screen (big font)", fontScale = 1.5f, device = "id:pixel_7")
@Composable
