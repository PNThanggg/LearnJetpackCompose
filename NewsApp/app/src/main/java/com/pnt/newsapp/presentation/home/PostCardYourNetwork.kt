...
import com.pnt.newsapp.data.posts.impl.post1
import com.pnt.newsapp.data.posts.impl.post2
import com.pnt.newsapp.data.posts.impl.post3
import com.pnt.newsapp.data.posts.impl.post4
import com.pnt.newsapp.data.posts.impl.post5
 ...
 * @Preview
 * @Composable
 * fun MyPreview(@PreviewParameter(com.pnt.newsapp.presentation.home.PostPreviewParameterProvider::class, limit = 2) post: Post) {
 *   MyComposable(post)
 * }
 * ```
 *
